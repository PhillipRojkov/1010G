...
void AutoFunctions::resetDriveEncoders() { // Resets all driver encoder positions to zero
  ...
  double AutoFunctions::avgDriveEncoder() { // Returns average of all driver encoder positions
  ...
  double
  AutoFunctions::absAvgDriveEncoder() { // Returns average of all drive encoder abs positions
  ...
  void AutoFunctions::drive(int dir, double speed) { // Drive forward (dir = 1) or backward
  ...
  void AutoFunctions::strafe(int dir,
  ...
  void
  AutoFunctions::autoForward(double degrees, double iDeg, double fDeg,
  ...
  void
  AutoFunctions::autoForward(double degrees, double iDeg, double fDeg, bool intake,
              double speed) { // Forward auto function. degrees > iDeg + fDeg
    resetDriveEncoders();
    h = IMU.rotation();
    while (avgDriveEncoder() <
  ...
  void
  AutoFunctions::dumbForward(double degrees, double iDeg, double fDeg,
              double speed) { // Forward auto function. degrees > iDeg + fDeg
    resetDriveEncoders();
    h = IMU.rotation();
    while (avgDriveEncoder() <
  ...
  void
  AutoFunctions::dumbBackward(double degrees, double iDeg, double fDeg,
  ...
  void
  AutoFunctions::autoBackward(double degrees, double iDeg, double fDeg,
               double speed) { // Backward auto function. degrees > iDeg + fDeg
    resetDriveEncoders();
    h = IMU.rotation();
    while (fabs(avgDriveEncoder()) <
  ...
  void AutoFunctions::autoTurnTo(double degrees) { //+degrees turns right, -degrees turns left
